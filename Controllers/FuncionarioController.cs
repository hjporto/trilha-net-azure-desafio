...
public class FuncionarioController : ControllerBase
{
    ...
    [HttpGet("{id}")]
    public IActionResult ObterComId(int id)
    {
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        return CreatedAtAction(nameof(ObterComId), new { id = funcionario.Id }, funcionario);
    }
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        funcionarioBanco.DataDeAdmissao = funcionario.DataDeAdmissao;
